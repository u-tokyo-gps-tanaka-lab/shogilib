...
def test_plm_piece():
    ...
    pos = Position.from_fen(
        "4k4/P8/9/1LN6/9/9/9/9/4K4[pppppppppPPPllLnnNssSSggGGbBrR] w"
    )
    moves = []
...
def test_plm_drop():
    ...
    pos = Position.from_fen(
        ".nsgkgsnl/1r5b1/1pppppppp/9/9/9/1PPPPPPPP/1B5R1/L1SGKGSNL[pPLN] w"
    )
    moves = []
...
def test_plm():
    pos = Position.from_fen(
        ".nsgkgsnl/1r5b1/ppppppppp/9/9/9/1PPPPPPPP/1B5R1/LNSGKGSNL[PL] w"
    )
    moves_strs = [
        "L@a2",
        "L@a3",
